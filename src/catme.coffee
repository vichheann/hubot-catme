...
module.exports = (robot) ->
  ...
  robot.respond /cat( me)?$/i, (msg) ->
    msg.http("https://thecatapi.com/api/images/get?format=xml")
      .get() (err, res, body) ->
  ...
  robot.respond /cat bomb( (\d+))?/i, (msg) ->
    ...
    msg.http("https://thecatapi.com/api/images/get?format=xml&results_per_page=" + count)
      .get() (err, res, body) ->
        msg.send $(cat).find('url').text() for cat in $(body).find('image')

  robot.respond /cat categories/i, (msg) ->
    msg.http("https://thecatapi.com/api/categories/list")
      .get() (err, res, body) ->
